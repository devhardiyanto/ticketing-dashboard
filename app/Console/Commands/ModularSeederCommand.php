...
class ModularSeederCommand extends Command
{
	...
	protected $modules = [
		...
		'users-internal' => [
			'label' => 'Internal Users (Super Admin, Staff)',
			'dependencies' => ['roles', 'permissions'],
			'warning' => null,
		],
		'users-tenant' => [
			'label' => 'Tenant Users (Org Admins)',
			'dependencies' => ['roles', 'permissions'],
			'warning' => '⚠️  Warning: Requires Core organizations to be seeded',
		],
	];
	...
	protected function runSeeder(string $action, string $module): void
	{
		$methodMap = [
			'up' => [
				...
				'users-internal' => [DatabaseSeeder::class, 'seedInternalUsersModule'],
				'users-tenant' => [DatabaseSeeder::class, 'seedTenantUsersModule'],
			],
			'down' => [
				...
				'users-internal' => [DatabaseSeeder::class, 'clearUsersModule'],
				'users-tenant' => [DatabaseSeeder::class, 'clearUsersModule'],
			],
		];
